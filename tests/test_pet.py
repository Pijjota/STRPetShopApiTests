...
class TestPet:
    ...
    def test_add_pet_all_data(self):
        with allure.step("Подготовка данных для создания питомца"):
            payload = {
                "id": 10,
                "name": "doggie",
    ...
    def test_put_pet_by_id(self, create_pet):
        ...
        with allure.step("Проверка статуса ответа на создание"):
            assert response.status_code == 200
            assert response.json()["id"] == pet_id
        ...
        with allure.step("Проверка статуса ответа на обновление"):
            assert response.status_code == 200
            assert response.json()["id"] == pet_id
    ...
    def test_delete_pet_by_id(self, create_pet):
        ...
        with allure.step("Проверка статуса ответа на создание питомца"):
            assert response.status_code == 200
            assert response.json()["id"] == pet_id
        ...
        with allure.step("Отправка запроса для проверки удаления питомца"):
            response = requests.get(f"{BASE_URL}/pet/{pet_id}")

        with allure.step("Проверка статуса ответа что питомец удален"):
    ...
    def test_get_pets_by_status(self, status, expected_status_code):
        ...
        with allure.step("Проверка статус ответа и формата данных"):
